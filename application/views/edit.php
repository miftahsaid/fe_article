                    ...
                    <div class="tab-content rounded-bottom">
                      <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-494">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="title_" name="title_" value="<?=$article[0]['Title']; ?>" >
                        </div>

                        <div class="mb-3">
                          <label class="form-label" for="content_">Content</label>
                          <textarea class="form-control" id="content_" name="content_" rows="3"><?=$article[0]['Content']; ?></textarea>
                        </div>

                        <div class="mb-3">
                          <label class="form-label" for="category_">Category</label>
                          <input class="form-control" id="category_" name="category_" value="<?=$article[0]['Category']; ?>">
                        </div>
                      </form>
...
<script type="text/javascript">
  ...
  $(function(){
    $("#publish").click(function(){
        ...
        var action = '<?=base_url()?>index.php/Article/edit_post/<?=$article[0]['id']; ?>/publish';
  ...
  $(function(){
    $("#draft").click(function(){
        var form = $('#article_form');
        var action = '<?=base_url()?>index.php/Article/edit_post/<?=$article[0]['id']; ?>/draft';
        form.attr('action', action);
        form.submit();
    });
  });
